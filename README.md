# file-uploader
In this project, I’ll be building a personal storage service.
...
- on click take to single folder page show all files from there edit folder name redirect to single page folder or delete it redirect to folders

  Save the file in your filesystem for now. You’ll need to integrate the multer middleware. We’ll upload these files once we have all other features working.

 Users should be able to CRUD folders and upload files in them. Set up routes and necessary database interactions for this.
